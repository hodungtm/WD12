...
<body>
    ...
    <div id="offcanvas-wishlist" class="offcanvas offcanvas-wishlist theme1">
        <div class="inner">
            ...
            <a href="wishlist.html"
                class="btn theme--btn-default btn--lg d-block d-sm-inline-block rounded-5 mt-30">view
                wishlist</a>
        </div>
    </div>
    ...
    <div id="offcanvas-cart" class="offcanvas offcanvas-cart theme1">
        <div class="inner">
            ...
            <a href="cart.html" class="btn theme--btn-default btn--lg d-block d-sm-inline-block rounded-5 me-sm-2">view
                cart</a>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6 col-lg-2 order-first">
                        <div class="logo text-center text-sm-start mb-30 mb-sm-0">
                            <a href="index.html"><img src="assets/img/logo/ChatGPT Image Jun 23, 2025, 11_17_10 AM.png"
                                    alt="logo"></a>
                        </div>
                    </div>
