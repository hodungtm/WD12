...
<style>
    ...
    .status-confirmed { background: #d1ecf1; color: #0c5460; border: 2px solid #74b9ff; }
    .status-shipping { background: #cce5ff; color: #004085; border: 2px solid #0984e3; }
    .status-completed { background: #d4edda; color: #155724; border: 2px solid #00b894; }
    .status-cancelled { background: #f8d7da; color: #721c24; border: 2px solid #e17055; }
    .payment-paid { background: #d4edda; color: #155724; border: 2px solid #00b894; }
    .payment-pending { background: #fff3cd; color: #856404; border: 2px solid #ffeaa7; }
...
<main class="order-detail-container">
    ...
    <div class="info-grid">
        ...
        <div class="info-card">
            ...
            <p><strong><i class="fas fa-calendar-alt me-2"></i>Ngày đặt:</strong> {{ \Carbon\Carbon::parse($order->order_date)->format('d/m/Y H:i') }}</p>
        </div>
    ...
    <div class="order-summary">
        ...
        <div class="summary-row">
            ...
            <span>{{ number_format($order->final_amount - $items->sum('total_price'), 0, ',', '.') }}₫</span>
        </div>
        <div class="summary-row">
