...
<div id="offcanvas-wishlist" class="offcanvas offcanvas-wishlist theme3">
    <div class="inner">
        ...
        <ul class="minicart-product-list">
            <li>
                <a href="single-product.html" class="image"><img src="assets/img/single-product/1.2x.jpg"
            ...
            <li>
                <a href="single-product.html" class="image"><img src="assets/img/single-product/2.2x.jpg"
                        alt="Cart product Image"></a>
                <div class="content">
            ...
            <li>
                <a href="single-product.html" class="image"><img src="assets/img/single-product/3.2x.jpg"
                        alt="Cart product Image"></a>
                <div class="content">
...
<div id="offcanvas-cart" class="offcanvas offcanvas-cart theme3">
    <div class="inner">
        ...
        <a href="cart.html" class="btn theme--btn-ddefault btn--lg d-block d-sm-inline-block rounded-5 me-sm-2">view
            cart</a>
                                ...
                                <ul class="mega-menu row">
                                    ...
                                    <li class="col-12 mt-4">
                                        <a href="single-product.html" class="zoom-in overflow-hidden"><img
                                                src="assets/img/mega-menu/4.jpg" alt="img"></a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <div class="d-flex flex-wrap w-100 align-items-center">
                        <div class="vertical-menu d-none d-lg-block">
                            <button class="menu-btn d-flex"><span class="ion-android-menu"></span>All Categories<span
                                    class="ion-ios-arrow-down d-block ms-auto"></span> </button>
                        ...
                        <div class="search-form width-calc-from-left ps-35 mt-30 mt-lg-0">
                ...
                <div class="single-product-info">
                    <div class="single-product-head">
                        ...
                        <div class="star-content mb-20">
                            ...
                            <span class="star-on"><i class="ion-ios-star"></i> </span>
                            <span class="star-on"><i class="ion-ios-star"></i> </span>
                            <a href="#" id="write-comment"><span class="me-2"><i class="far fa-comment-dots"></i></span>
                                Read reviews <span>(1)</span></a>
                            <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><span class="edite"><i
                                        class="far fa-edit"></i></span> Write a review</a>
                        </div>
                    </div>
                    <div class="product-body mb-40">
                        <div class="d-flex align-items-center mb-30">
                            <h6 class="product-price me-2"><del class="del">$23.90</del>
                        ...
                        <div class="single-product-desc">
                            ...
                            <div class="grade-content">
                                ...
                                <a href="#" class="btn theme-btn--dark3 theme-btn--dark3-sm btn--sm rounded-5 mt-15"
                                    data-bs-toggle="modal" data-bs-target="#exampleModalCenter">Write your review !</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-product-info">
                            ...
                            <div class="product-body mb-40">
                                <div class="d-flex align-items-center mb-30">
                                    <h6 class="product-price"><del class="del">$23.90</del>
                                        <span class="onsale">$21.51</span></h6>
                                    <span class="badge position-static bg-dark p-2 rounded-0 ms-2">Save 10%</span>
                                </div>
                    ...
                    <div class="col-md-6 mt-4 mt-md-0">
                        <div class="modal-form">
                            ...
                            <div class="star-content pb-3">
                                <span class="quality me-2">Quality</span>
                                <span class="star-on"><i class="ion-ios-star"></i> </span>
                                <span class="star-on"><i class="ion-ios-star"></i> </span>
                                <span class="star-on"><i class="ion-ios-star"></i> </span>
                                <span class="star-on"><i class="ion-ios-star"></i> </span>
