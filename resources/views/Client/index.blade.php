...
<body>
    ...
    <header>
        ...
        <!-- main slider end -->
        <!-- common banner  start -->
        <section class="product-category-section pt-65 pb-65">
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center mb-30">
                        <h2 class="category-heading text-dark">Danh Mục Sản Phẩm</h2>
                        <p class="category-subheading">Khám phá các danh mục thể thao nổi bật của cửa hàng.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="brand-init border-top slick-nav-brand">
                            @foreach($categories as $category)
                            <div class="single-category text-center px-3">
                                <a href="" class="d-block mb-2">
                                    <img src="{{ asset('storage/' . $category->anh) }}"
                                        alt="{{ $category->ten_danh_muc }}" style="height: 150px; margin: auto;">

                                </a>
                                <h6 class="mb-1">{{ $category->ten_danh_muc }}</h6>
                                        ...
                                        <div class="card product-card">
                                            <div class="card-body p-2">
                                                <div class="product-thumbnail position-relative text-center">
                                                    ...
                                                    <a href="#">
                                                        <img class="img-fluid"
                                                            src="{{ asset('storage/' . $product->firstImage->image) }}"
