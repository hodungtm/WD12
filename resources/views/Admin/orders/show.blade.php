                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <div>
                                                    ...
                                                    <span
                                                        style="font-size: 1.2em; color: red; font-weight: bold;">{{ $order->order_code }}</span>
                                                </div>
                                                ...
                                                @foreach ($order->orderItems as $item)
                                                    ...
                                                    <div class="row g-0 {{ !$loop->last ? 'mb-4 pb-4 border-bottom' : '' }}">
                                                        ...
                                                        <div class="col-sm-7">
                                                            ...
                                                            <p class="no-dots" style="font-size: 15px;">
                                                                Đơn giá:
                                                                {{ number_format($item->final_price ?? $item->price, 0, ',', '.') }}
                                                                VNĐ
                                                            </p>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mb-3 bg-light">
                                            <div class="card-body">
                                                ...
                                                <div style="display: flex; align-items: center; margin-bottom: 20px">
                                                    <div
                                                        style="width: 40px; height: 40px; border-radius: 10%; margin-right: 10px; background-color: #007bff; display: flex; align-items: center; justify-content: center; color: white;">
                                                        <i class="icon-user"></i>
                                                    </div>
                                        ...
                                        <div class="card mb-3 bg-light">
                                            <div class="card-body">
                                                ...
                                                <p style="font-size: 15px;"><span
                                                        style="font-weight: bold; color: #0056b3;">Người nhận:</span><br>
                                                    {{ $order->receiver_name ?? 'Trùng người đặt' }}</p>

                                                <p style="font-size: 15px;"><span
                                                        style="font-weight: bold; color: #0056b3;">Địa chỉ giao
                                                        hàng:</span><br>
                                                    {{ $order->receiver_address ?? 'Không có' }}</p>

                                                <p style="font-size: 15px;"><span
                                                        style="font-weight: bold; color: #0056b3;">SĐT người
                                                        nhận:</span><br>
                                                    {{ $order->receiver_phone ?? 'Không có' }}</p>

                                                <p style="font-size: 15px;"><span
                                                        style="font-weight: bold; color: #0056b3;">Phương thức vận
                                                        chuyển:</span><br>
                                    ...
                                    <div class="col-12">
                                        <div class="card mb-3 bg-light">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <p style="font-size: 15px; font-weight: bold;">Phương thức thanh
                                                            toán: <span
                                                                style="padding: 5px;">{{ $order->payment_method }}</span>
                                                        </p>
                                                        <p style="font-size: 15px; font-weight: bold;">Trạng thái thanh
                                                            toán: <span
                                                                style="padding: 5px;">{{ $order->payment_status }}</span>
                                                        </p>
                                                        ...
                                                        @if($order->discount_code)
                                                            <p style="font-size: 15px; font-weight: bold;">Mã giảm giá: <span
                                                                    style="padding: 5px;">{{ $order->discount_code }}</span></p>
                                                        @endif
                                                    </div>

                                                    <div class="col-md-6">
                                                        @php $totalItemsPrice = $order->orderItems->sum('total_price'); @endphp
                                                        <p style="font-size: 15px;">Tổng tiền sản phẩm:
                                                            {{ number_format($totalItemsPrice, 0, ',', '.') }} VNĐ</p>
                                                        @php
                                                            $totalItemsPrice = $order->orderItems->sum('total_price');
                                                            $shippingFee = optional($order->shippingMethod)->fee ?? 0;
                                                            $isFreeShip = $totalItemsPrice >= 300000;
                                                        @endphp

                                                        <p style="font-size: 15px;">
                                                            Phí vận chuyển:
                                                            @if($isFreeShip)
                                                                <span style="color: green; font-weight: bold;">Miễn phí vận
                                                                    chuyển</span>
                                                            @else
                                                        ...
                                                        @if (($order->discount_amount ?? 0) > 0)
                                                            <p style="font-size: 15px;">Giảm giá:
                                                ...
                                                @if($order->note)
                                                    <hr>
                                                    <p style="font-size: 15px;"><span style="font-weight: bold;">Ghi
                                                            chú:</span><br>
                                                        {{ $order->note }}</p>
                                                @endif

                                                @if($order->cancel_reason)
                                                    <p style="font-size: 15px;"><span style="font-weight: bold; color: red;">Lý
                                                            do hủy:</span><br>
