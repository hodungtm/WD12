            ...
            <div class="tile">
                <div class="tile-body">
                    ...
                    <div class="d-flex align-items-center justify-content-start mb-3" style="gap: 10px;">
                        <a href="{{ route('posts.create') }}" class="btn btn-outline-success btn-sm d-flex align-items-center"
                            style="gap: 5px;">
                        ...
                        <tbody>
                            @forelse ($posts as $post)
                                <tr class="text-center align-middle">
                                    ...
                                    <td>
                                        <a href="{{ route('posts.show', $post) }}" class="btn btn-outline-info btn-sm" title="Xem"><i
                                                class="fas fa-eye"></i></a>
                                        <a href="{{ route('posts.edit', $post) }}" class="btn btn-outline-warning btn-sm" title="Sửa"><i
                                                class="fas fa-edit"></i></a>
                                        <form action="{{ route('posts.destroy', $post) }}" method="POST" class="d-inline"
                                            onsubmit="return confirm('Bạn có chắc muốn xóa?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-outline-danger btn-sm" title="Xóa"><i
