                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="index-2.html" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="{{ asset('https://themesflat.co/html/ecomus/images/logo/logo.svg') }}" data-light="{{ asset('https://themesflat.co/html/ecomus/images/logo/logo.svg') }}" data-dark="{{ asset('https://themesflat.co/html/ecomus/images/logo/logo-white.svg') }}" >
                        </a>
                            ...
                            <div class="center-item">
                                <ul class="">
                                    <li class="menu-item has-children">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item"><a href="{{ route('products.index') }}"><div class="text">Danh sách sản phẩm</div></a></li>
                                            <li class="sub-menu-item"><a href="{{ route('products.create') }}"><div class="text">Thêm sản phẩm</div></a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item has-children">
                                        <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item"><a href="{{ route('admin.orders.index') }}"><div class="text">Danh sách đơn hàng</div></a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item has-children">
                                        <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item"><a href="{{ route('Admin.categories.index') }}"><div class="text">Danh sách danh mục</div></a></li>
                                            <li class="sub-menu-item"><a href="{{ route('Admin.categories.create') }}"><div class="text">Thêm danh mục</div></a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item has-children">
                                        <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item"><a href="{{ route('Admin.comments.index') }}"><div class="text">Danh sách bình luận</div></a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item has-children">
                                        <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item"><a href="{{ route('Admin.reviews.index') }}"><div class="text">Danh sách đánh giá</div></a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item has-children">
                                        <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item"><a href="{{ route('admin.users.index') }}"><div class="text">Danh sách người dùng</div></a></li>
                                            <li class="sub-menu-item"><a href="{{ route('admin.users.create') }}"><div class="text">Thêm người dùng</div></a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item has-children">
                                        <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item"><a href="{{ route('posts.index') }}"><div class="text">Danh sách bài viết</div></a></li>
                                            <li class="sub-menu-item"><a href="{{ route('posts.create') }}"><div class="text">Thêm bài viết</div></a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item has-children">
                                        <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item"><a href="{{ route('admin.discounts.index') }}"><div class="text">Danh sách mã giảm giá</div></a></li>
                                            <li class="sub-menu-item"><a href="{{ route('admin.discounts.create') }}"><div class="text">Thêm mã giảm giá</div></a></li>
                                            <li class="sub-menu-item"><a href="{{ route('admin.discounts.report') }}"><div class="text">Báo cáo giảm giá</div></a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item has-children">
                                        <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item"><a href="{{ route('admin.banners.index') }}"><div class="text">Danh sách banner</div></a></li>
                                            <li class="sub-menu-item"><a href="{{ route('admin.banners.create') }}"><div class="text">Thêm banner</div></a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item has-children">
                                        <a href="javascript:void(0);" class="menu-item-button">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item"><a href="{{ route('catalog.index') }}"><div class="text">Danh sách thuộc tính</div></a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item">
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt="" src="{{ asset('https://themesflat.co/html/ecomus/images/logo/logo.svg') }}" data-light="{{ asset('https://themesflat.co/html/ecomus/images/logo/logo.svg') }}" data-dark="{{ asset('https://themesflat.co/html/ecomus/images/logo/logo-white.svg') }}" >
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-chevron-left"></i>
                                </div>
